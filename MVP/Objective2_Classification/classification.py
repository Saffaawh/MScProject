...
X = df.drop(columns=['PatientNumber', 'Gender','Scheduled Date and Time', 'Actual End Time', 'Class', 'Actual Scan Duration', 'Overrun Minutes'] )#dropping unneccessary columns
...
print(classification_report(y_test, y_pred_rf, labels=['Class 1', 'Class 2', 'Class 3']))
print("Confusion Matrix:")
