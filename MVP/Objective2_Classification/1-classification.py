...
extracted_model = rf_pipeline.named_steps['classifier']
joblib.dump(extracted_model, 'random_forest_model_extracted.joblib')

# 3. Save the Preprocessor (For SHAP to transform data)
extracted_preprocessor = rf_pipeline.named_steps['preprocessor']
joblib.dump(extracted_preprocessor, 'random_forest_preprocessor.joblib')

print("\nSUCCESS: Saved 'Pipeline' (for App) and 'Extracted Model' (for SHAP).")