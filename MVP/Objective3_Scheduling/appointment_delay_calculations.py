...
Categorical_features = [
    'Scan Type', 'Wheelchair User', 'Hoist Required','Poor Mobility', 'Learning Difficulty', 'Cognitive Impairment',
...
individual_flags = [
    'Poor Mobility', 'Wheelchair User', 'Hoist Required', 'Learning Difficulty', 'Cognitive Impairment',
    'Interpreter Required', 'Sedation needed', 'Difficult IV Access', 'Hospital Transport Required', 'Contrast'
]

data = df_historical[full_Features]
y_historical_raw = final_model.predict(data)
